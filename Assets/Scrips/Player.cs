...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if(isGrounded) GetComponent<Animator>().SetTrigger("Jump");
        ...
        {
            GetComponent<Rigidbody2D>().velocity = Vector2.up * jmpSpeed;
        }

        prevVx = vx;

        //ÃÑ¾Ë ¹ß»ç
        //if(Input.GetButtonDown("Fire1") && lastShoot + 0.5f < Time.time) // ÃÑ¾ËÀÇ ÄðÅ¸ÀÓ
